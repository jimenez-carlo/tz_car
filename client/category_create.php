...
<div class="container-fluid page-header">
    ...
    <div class="d-inline-flex text-white">
        ...
        <h6 class="text-uppercase text-body m-0">Category Create</h6>
    </div>
</div>

<div class="container-fluid pt-5">
    <div class="container pt-5">
        <?= isset($_POST['submit']) ? createCategory($_POST) : "" ?>
        <div class="row">
                    ...
                    <div class="bg-secondary p-5">
                        ...
                        <div class="row">
                            <div class="col-12 form-group">
                                <input type="text" class="form-control p-4" placeholder="Category Name" required="required" name="car_category" value="<?= $_POST['car_category'] ?? '' ?>">
                            </div>
                        </div>
