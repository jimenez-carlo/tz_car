...
<head>
  <title>TZ Car Rental | Interior</title>
...
<body>
  ...
  <div class="hai">
    ...
    <div class="book-car-container">
      <h1 style="text-align: center;"><?= $car->CAR_NAME ?></h1>
      <h2>Car Photos</h2>
        ...
        <div class="row">
          <div class="col-md-6">
            <fieldset>
              <table>
                <?php
                foreach (get_list("select * from car_interrior where CAR_ID = " . $_GET['car_id']) as $key => $res) {

                ?>
                  <tr>
                    <td colspan="2">
                      <img src="../images/<?= $res['image'] ?>" alt="" style="width:310px;height:150px">
                    </td>
                  </tr>
                <?php } ?>
                <?php if (empty(count(get_list("select * from car_interrior where CAR_ID = " . $_GET['car_id'])))) { ?>
                  <tr>
