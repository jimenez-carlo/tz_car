        ...
        <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post">
                                        ...
                                        <a href="users_edit.php?id=<?= $result['user_id'] ?>" class="btn btn-sm btn-primary"> <i class="fa-regular fa-pen-to-square"></i> </a>
                                    </form>
                                </td>
                            </tr>
                        <?php  } ?>
            ...
            <!-- <div class="col-lg-4 mb-5">
                <div class="bg-secondary p-5">
                    <h3 class="text-primary text-center mb-4">Create Client</h3>
