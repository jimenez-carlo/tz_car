...
<div class="container-fluid pt-5">
    <div class="container pt-5">
        ...
        <?= isset($_POST['cancel']) ? cancelBook($_GET['id']) : "" ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mb-5">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="payment_status_id" value="<?= $data->payment_status_id ?>">
                    <input type="hidden" name="book_status_id" value="<?= $data->book_status_id ?>">
                    <div class="bg-secondary p-5">
                        <h3 class="text-primary mb-4">Book Update <select class="px-4 float-end" style="float:right;font-size:1em" required name="book_status_id" disabled>
                        ...
                        <div class="row">
                            <div class="col-12 form-group">
                                <select class="custom-select px-4" style="height: 50px;" required name="car_id" <?= ($data->book_status_id <> 1) ? "disabled" : "" ?>>
...
WHERE (b.car_id IS NULL or b.car_id = $data->car_id )and c.deleted_flag = 0 ") as $result
                            ...
                            <div class="col-6 form-group">
                                <div class="date" id="date1" data-target-input="nearest">
                                    <input type="text" class="form-control p-4 datetimepicker-input" placeholder="Start Date"
                                        data-target="#date1" data-toggle="datetimepicker" name="start_date" value="<?= $_POST['date_start'] ?? $data->date_start ?>" <?= ($data->book_status_id <> 1) ? "disabled" : "" ?> />
                                </div>
                            </div>
                            <div class="col-6 form-group">
                                <div class="date" id="date2" data-target-input="nearest">
                                    <input type="text" class="form-control p-4 datetimepicker-input" placeholder="End Date"
                                        data-target="#date2" data-toggle="datetimepicker" name="end_date" value="<?= $_POST['date_end'] ?? $data->date_end ?>" <?= ($data->book_status_id <> 1) ? "disabled" : "" ?> />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 form-group">
                                <select class="custom-select px-4" style="height: 50px;" required name="payment_status_id" <?= ($data->book_status_id <> 1) ? "disabled" : "" ?>>
                        ...
                        <div class="form-group mb-0">
                            <div class="row">
                                <div class="col-6">
                                    <button class="btn btn-primary btn-block" type="submit" style="height: 50px;" name="submit">Update</button>
                                </div>
                                <div class="col-6">
                                    <button class="btn btn-primary btn-block" type="submit" style="height: 50px;" name="cancel" <?= ($data->book_status_id <> 1) ? "disabled" : "" ?>>Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
