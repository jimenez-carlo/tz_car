...
<body>
  ...
  <div class="hai">
    ...
    $book = get_one("select * from booking where BOOK_ID = '$book_id'");
    ?>
    <div class="book-car-container">
      <h2>Transaction Detail (EXTEND)</h2>
      <form id="register" method="POST" enctype="multipart/form-data">
            ...
            <fieldset>
              ...
              <table>
                <tr>
                  ...
                  <td>
                    <input type="datetime-local" name="book_date" required id="book_date" disabled value="<?= $book->RETURN_DATE ?>">
                    <input type="hidden" name="book_date" required id="book_date" value="<?= $book->RETURN_DATE ?>">
                  </td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <input type="number" name="phone_no" required value="<?= $book->PHONE_NUMBER ?>">
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <textarea name="book_place" rows="5" required><?= $book->BOOK_PLACE ?></textarea>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <textarea name="destination" rows="5" required><?= $book->DESTINATION ?></textarea>
                  </td>
                </tr>
              </table>
            </fieldset>
        ...
        <input type="hidden" name="book_status" value="EXTENDED">
