...
<div class="container-fluid bg-secondary py-5 px-sm-3 px-md-5" style="margin-top: 90px;">
  <div class="row pt-5">
    <div class="col-lg-3 col-md-6 mb-5">
      ...
      <p class="mb-2"><i class="fa fa-map-marker-alt text-white mr-3"></i>Urdaneta,
        Pangasinan,
        55060</p>
      <p class="mb-2"><i class="fa fa-phone-alt text-white mr-3"></i>+0961-428-4823</p>
      <p><i class="fa fa-envelope text-white mr-3"></i>tzcarrental@gmail.com</p>
