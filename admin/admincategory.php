...
<body>
    ...
    <div class="hai">
        <div class="header-container">
            ...
            <button class="add"><a href="addcategory.php">+ ADD CATEGORY</a></button>
        </div>
        <div class="table-container">
            <table class="content-table">
                ...
                <tbody>
                    <?= (isset($_POST['delete'])) ? deleteItem("category", "id", $_POST['id']) : ''; ?>
                    <?php



                    foreach (get_list("select * from category") as $key => $res) {
                        # code...
                    ?>
                        <tr class="active-row">
                            ...
                            <td>
                                <form method="post">
                                    ...
                                    <button type="submit" name="delete" class="but">DELETE CATEGORY</button>
                                </form>
                            </td>
