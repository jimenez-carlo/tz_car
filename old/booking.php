    ...
    <style>
        ...
        * {
        ...
        .navbar-background {
            ...
            padding: 10px;
            position: fixed;
            /* Add this to fix the navbar to the top */
            top: 0;
            /* Add this to fix the navbar to the top */
            left: 0;
            /* Add this to fix the navbar to the left */
            right: 0;
            /* Add this to fix the navbar to the right */
        }
    ...
    <div class="hai">
        <div class="navbar-background">
            <div class="navbar">
                ...
                <div class="menu" style="float: right; width: 70%;">
                    <ul>
