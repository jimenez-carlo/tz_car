...
<body>
  <style>
    ...
    * {
    ...
    body {
      ...
      align-items: center;
      background: orange url("images/gcashbg.jpg") center/cover;
      overflow: hidden;
    }
  ...
  <h2 class="payment" style="background-color: #ff7200; color: white; padding: 10px; border-radius: 10px; margin-top: -550px; margin-left: 1000px;">TOTAL PAYMENT :
    <a>₱<?php echo $email['PRICE'] ?>/-</a>
  </h2>

  <div class="card">
    <form method="POST">
      <h1 class="card__title">Enter Gcash Information</h1>
      <div class="card__row">
        <div class="card__col">
          <label for="cardNumber" class="card__label">GCash Number</label><input
            type="text"
      ...
      <div class="card__row">
        <div class="card__col">
          <label for="cardExpiry" class="card__label">Expiry Date</label><input
            type="text"
            class="card__input"
            id="cardExpiry"
            placeholder="xx/xx"
        ...
        <div class="card__col">
          <label for="cardCcv" class="card__label">CCV</label><input
            type="password"
            class="card__input"
            id="cardCcv"
            placeholder="xxx"
